...
// SQ $nsquared_status = isset($product_status["nsquared"]["status"]) ? $product_status["nsquared"]["status"] : null;
...
// SQ if ($nsquared_status == 1) { define('NRELATE_NSQUARED_ACTIVE', true); }
